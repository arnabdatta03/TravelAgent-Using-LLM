...
guide_expert = Agent(
    ...
    verbose=True,
    max_iter=5,
    llm=LLM(model="ollama/llama3.2:latest",base_url="http://127.0.0.1:11434"),
...
location_expert = Agent(
    ...
    verbose=True,
    max_iter=5,
    llm= LLM(model="ollama/llama3.2:latest",base_url="http://127.0.0.1:11434"),   # ChatOpenAI(temperature=0, model="gpt-4o-mini"),
    allow_delegation=False,
)
